...
from extraction.company import extract_company_firmographics, extract_company_discovery
...
def ingest_company_payload(request: CompanyIngestRequest) -> dict:
    """
...
@modal.fastapi_endpoint(method="POST")
def ingest_company_discovery(request: CompanyDiscoveryRequest) -> dict:
    """
