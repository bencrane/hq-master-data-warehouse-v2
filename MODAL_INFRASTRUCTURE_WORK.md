...
**Date:** January 6, 2026  
**Status:** Code committed, deployment blocked by endpoint limits
...
4. **No Pydantic at Module Level**: Request validation uses plain dict types instead of Pydantic models at the function signature level.
...
2. **Local Dependencies**: The deploy command requires Modal to be installed locally. Heavy dependencies like supabase and openai are only needed in the Modal image, not locally.
